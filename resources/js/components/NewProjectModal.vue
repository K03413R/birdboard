<template>
    <modal name="new-project" classes="p-10 bg-card rounded-lg" height="auto">
        <h1 class="font-normal mb-20 text-center text-2xl">Let's start something new</h1>
        <form @submit.prevent="submit">
            <div class="flex">
                <div class="flex-1 mr-4">
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            v-model="form.title"
                            :class="form.errors.title ? 'border-red-700' : 'border-light'"
                        >
                ...
                <div class="flex-1 ml-4">
                    <div class="mb-4">
                        <label class="text-sm block mb-">Need some tasks</label>
                        <input
                            placeholder="Task Name"
                            type="text"
                            class="border border-light p-2 text-xs block w-full rounded mb-2"
